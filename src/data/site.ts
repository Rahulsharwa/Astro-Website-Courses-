...
export const categoryFaqs: CourseFaq[] = [
  ...
  { question: "Which computer course is best after 10th?", answer: "DCA is the usual choice after 10th — it is a full computer diploma course affiliated to Dr. C.V. Raman University and covers fundamentals, MS Office and typing. If you want something shorter first, start with the basic computer course." },
  { question: "Which computer course is best after 12th?", answer: "PGDCA is the natural computer course after 12th, going further into programming logic, databases, SQL and web technology. Job seekers who want a shorter, specific skill often choose Tally Prime or the data entry operator course instead." },
